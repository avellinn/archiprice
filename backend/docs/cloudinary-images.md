...
Le `POST` accepte un nombre illimité d'images côté métier. Chaque fichier reste validé individuellement en PNG, JPG ou WebP, avec une taille maximale de 5 Mo.
